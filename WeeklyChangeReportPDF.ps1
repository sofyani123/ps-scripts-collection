...
$destinationBasePath = "S:\Business Change and Infrastructure\IT\Reports\Weekly Change Report Bluechip"
...
$pdfFiles = Get-ChildItem -Path $directoryPath -Filter "SGEF_Weekly Change Report*.pdf"
...
foreach ($pdfFile in $pdfFiles) {
    ...
    if ($extractedDate) {
        ...
        $newFileName = "SGEF_Weekly Change Report ${extractedDate}.pdf"
